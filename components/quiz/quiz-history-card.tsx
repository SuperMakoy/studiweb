  ...
  return (
    <>
      <div
        ...
        className="bg-[#5B6EE8] text-white rounded-2xl p-5 hover:shadow-xl transition transform hover:scale-105 cursor-pointer"
      >
        ...
        <div className="grid grid-cols-2 gap-4 mb-4">
          <div>
            ...
            <p className="text-lg opacity-90 mt-0.5">{percentage}%</p>
          </div>

          <div>
            <p className="text-[10px] opacity-70 uppercase tracking-wide mb-0.5">Points Earned</p>
            <p className="text-2xl font-bold">{quiz.points || 0}</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <p className="text-base font-semibold">{quiz.timeElapsed}</p>
          </div>

          <div>
            <p className="text-[10px] opacity-70 uppercase tracking-wide mb-0.5">Difficulty</p>
            <p className="text-base font-semibold">{formatDifficulty(quiz.difficulty || "moderate")}</p>
          </div>
        </div>
