...
export default function PendingQuizzesPage() {
  ...
  const loadQuizzes = async () => {
    try {
      ...
      // Filter only pending quizzes
      const pendingQuizzes = data.filter(q => q.evaluationStatus === "pending")
      ...
      <div className="flex-1 flex flex-col overflow-hidden pt-14 md:pt-0">
        ...
        <header className="bg-white border-b border-gray-200 px-4 md:px-8 py-3 md:py-4">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-lg md:text-2xl font-semibold text-gray-900">Pending Review</h1>
              <p className="text-gray-500 text-xs md:text-sm mt-0.5">
                Quizzes awaiting taxonomy evaluation
              </p>
            </div>
          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm">
            ...
            {quizzes.length === 0 ? (
              <div className="p-8 md:p-12 text-center">
                <AlertCircle className="w-12 h-12 md:w-16 md:h-16 mx-auto text-gray-300 mb-4" />
                <h3 className="text-base md:text-lg font-medium text-gray-900">No pending quizzes</h3>
                <p className="text-gray-500 text-sm mt-2">
                  All quizzes have been evaluated
                </p>
                <Button
                  ...
                  >
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-3">
                      ...
                      <Button
                        ...
                        className="w-full md:w-auto text-sm bg-[#5B6EE8] hover:bg-[#4A5AC9] text-white"
                      >
                        Evaluate
