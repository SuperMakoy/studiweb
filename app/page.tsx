      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .sp-hero-top {
          ...
          gap: 64px; width: 100%; max-width: 960px;
        ...
        <section className="sp-hero">
          ...
          <div className="sp-card">
            <div className="sp-tabs">
              ...
              <button type="button" className={`sp-tab${tab==="signup"?" on":""}`} onClick={() => switchTab("signup")}>Create account</button>
            </div>
            ...
            {tab === "login" ? (
              <form onSubmit={handleLogin}>
                ...
                <input
                  className="sp-inp" type="email" placeholder="you@example.com"
                ...
                <input
                  className="sp-inp" type="password" placeholder="••••••••"
              ...
              <form onSubmit={handleSignup}>
                ...
                <input
                  className="sp-inp" type="text" placeholder="Your name"
                ...
                <label className="sp-lbl">Password</label>
                <input
                  className="sp-inp" type="password" placeholder="Min. 6 characters"
                ...
                <input
                  className="sp-inp" type="password" placeholder="Repeat password"
